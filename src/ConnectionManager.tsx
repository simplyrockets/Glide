...
import { FormGroup, InputGroup, Dialog, Classes, Button, AnchorButton, Intent } from "@blueprintjs/core";
...
export function ConnectionManager(props: IProps) {
  ...
  return <>
    ...
    />
    <Dialog icon={IconNames.CELL_TOWER} title="Connection Manager" isOpen={isOpen} onClose={() => setIsOpen(false)}>
